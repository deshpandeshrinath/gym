...
class Actor(Model):
    ...
    """
    def __init__(self, num_actions, hidden_units=64, num_layers=1, name='actor', layer_norm=True):
...
class Critic(Model):
    ...
    """
    def __init__(self, hidden_units=64, num_layers=1, name='critic', layer_norm=True):
        """ setting placeholders and output pipeline
        """
...
class Curiosity(Model):
    def __init__(self, hidden_units=64, num_layers=1, name='curiosity', layer_norm=True):
        """ setting placeholders and output pipeline
        """
        super(Curiosity, self).__init__(name=name)
...
class CuriosityAE(Model):
    def __init__(self, hidden_units=64, num_layers=1, name='curiosity', layer_norm=True):
        """ setting placeholders and output pipeline
        """
        super(CuriosityAE, self).__init__(name=name)
